"""
Django settings for mithilesprodnew_42196 project.
...
ROOT_URLCONF = 'mithilesprodnew_42196.urls'
...
WSGI_APPLICATION = 'mithilesprodnew_42196.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mithilesprodnew_42196 API",
    "DESCRIPTION": "API documentation for mithilesprodnew_42196 App",
    "VERSION": "v1",
}
